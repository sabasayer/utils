...
export abstract class EnumUtil {
  ...
  static flaggedEnumToValueTextPair<T>(enumType: T, value: number): IValueTextPair[] {
    return EnumUtil.toValueTextPair(enumType, (enumValue: number) => (value & enumValue) == enumValue);
  }
}
